      ...
      <div class="head">
            <v-row>
              <v-col cols="5">
                ...
                <h1 class="text-white">I'm Aditi Vilas Sonkusare</h1>
                <span class="text-grey">Graduate Software Developer</span><br />
              ...
              <v-col cols="5">
                <div style="position:relative;z-index:9999;" class="mt-16">
                  <vimg src="favicon.ico" contain max-height="300"></vimg> 
                </div>
              </v-col>
            </v-row>
